...
namespace server
{
    ...
    extern clientinfo *getclientinfo(int n);
...
namespace server
{
    namespace auth
    {
        //extern void setprivilege(server::clientinfo *ci, bool val, int flags = 0, bool authed = false, bool local = false);
        //extern void namesrequest(server::clientinfo *ci, uint ip, uint mask);
        void setprivilege(server::clientinfo *ci, bool val, int flags, bool authed, bool local);
        void namesrequest(server::clientinfo *ci, uint ip, uint mask);
    }
}
