...
extern bool connectedlocalmaster();
extern ENetSocket connectlocalmaster(bool reuse = true);
extern void disconnectlocalmaster();
extern bool requestlocalmaster(const char *req);
extern bool requestlocalmasterf(const char *fmt, ...);
